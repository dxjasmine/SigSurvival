...
#' to creat a record of censoring event into numeric value
#'
#' A function to convert the censoring event into numeric
#' value for surivival analysis
#'
#' @param x event
#'
#' @return return the result if the x event is censored
#'
#' @example
#'
#' recordstatus("Alive")
